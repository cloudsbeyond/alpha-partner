...
If activated from another project with little context, use `partner/activation-guide.md`. In a local project, run `scripts/context-snapshot.sh` when it helps reconstruct the scene.
