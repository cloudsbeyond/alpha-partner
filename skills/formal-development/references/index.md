...
- [Layer Glossary](layer-glossary.md) - Shared L0-L4 terminology, goals, non-goals, carriers, anti-examples, and few-shot classification for formal-development reviews.
- [Non-Coding L0-L4](non-coding-l0-l4.md) - Non-coding formal-development coverage, minimum L0-L4 shape, L4 evidence carriers, and few-shot examples for research, SOPs, workflows, content products, knowledge assets, reviews, and decision memos.
