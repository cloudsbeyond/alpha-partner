...
write_if_missing "$ROOT/.alphaX/process/reviewer-backlog.md" <<'EOF'
# Local Reviewer Backlog

schema_version: 1

Record local review-agent todos and unsettled review consensus when needed.
EOF
