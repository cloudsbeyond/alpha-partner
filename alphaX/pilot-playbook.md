...
Use this from the project or conversation:
...
7. If this is a source work pilot and a local ledger exists, add one entry to this checkout's ignored `.alphaX/process/session-ledger.md` when the pilot ends.
