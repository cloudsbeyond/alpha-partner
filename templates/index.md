...
- [Checkpoint Memory Evaluation](checkpoint-memory-evaluation.md) - Template for checkpoint-bounded re-entry, update, evidence, and action memory evaluation.
- [Loop Report](loop-report.md) - Template for manual-trigger loops and proactive nudge candidates.
- [Memory Candidate Packet](memory-candidate-packet.md) - Template for reviewable memory candidates before durable memory updates.
- [Project Review Report](project-review/report.md) - Report template for reviewing project claims, evidence, drift, lifecycle hygiene, and next action.
